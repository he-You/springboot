 ...
 */
public class Md5AndSaltsWithSha1 {
    /**
     * md5和sha-1混合加密
...
// 生成最终的加密盐
    ...
    public static void main(String[] args) {
        ...
        // 获取加盐后的MD5值
        String ciphertext = Md5AndSaltsWithSha1.getSaltMd5AndSha(plaintext);
        System.out.println("加盐后MD5：" + ciphertext);
        System.out.println("是否是同一字符串:" + Md5AndSaltsWithSha1.getSaltverifyMd5AndSha(plaintext, ciphertext));
    }
